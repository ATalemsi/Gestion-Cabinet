        ...
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            <li class="leading-normal text-sm">
              <p class="opacity-50 text-slate-700" >Pages</p>
            </li>
            <li
...
export default {
  ...
  methods: {
    fetchSecretaries() {
      let url = 'https://api.majrinadiapsychiatre.com/api/index/secretaries';
      if (this.searchQuery) {
    ...
    softDeleteSecterary(secretaryId) {
      axios.delete(`https://api.majrinadiapsychiatre.com/api/deletesecretary/${secretaryId}`)
          .then(response => {
